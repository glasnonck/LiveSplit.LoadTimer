...
namespace LiveSplit.UI.Components
{
    ...
    {
        public String LoadTimeText { get; set; }
        ...
        public const string DEFAULT_LOADTIMETEXT = "Load Time";
        ...
        public AlternateTimingMethodSettings()
        {
            ...
            Display2Rows = false;
            LoadTimeText = DEFAULT_LOADTIMETEXT;

            txtGT.DataBindings.Add("Text", this, "LoadTimeText", false, DataSourceUpdateMode.OnPropertyChanged);
        ...
        public void SetSettings(XmlNode node)
        {
            ...
            LoadTimeText = (element["LoadTimeText"] != null) ? element["LoadTimeText"].InnerText : DEFAULT_LOADTIMETEXT;
        ...
        public XmlNode GetSettings(XmlDocument document)
        {
            ...
            parent.AppendChild(ToElement(document, "LoadTimeText", LoadTimeText));
